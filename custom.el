(custom-set-variables
 ...
 '(browse-url-epiphany-arguments '("-n"))
 '(c-default-style
   '((c-mode . "linux")
     (java-mode . "java")
     (awk-mode . "awk")
 ...
 '(erc-autoaway-mode t)
 '(erc-autojoin-channels-alist '(("freenode.net" "#haskell-hacboston" "#haskell")))
 ...
 '(haskell-ghci-program-args '("-fglasgow-exts"))
 '(haskell-mode-hook '(turn-on-haskell-indentation interactive-haskell-mode) t)
 ...
 '(markdown-command "pandoc -f markdown_github+yaml_metadata_block -t html -s")
 '(menu-bar-mode nil)
 '(org-agenda-files '("~/org/notes.org" "~/org/projects.org"))
